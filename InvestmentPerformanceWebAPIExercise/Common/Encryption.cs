...
namespace InvestmentPerformanceWebAPIExercise.Common
{
    public class Encryption
    {
        ...
        private static readonly string _salt = _config["AppSettings:Salt"] ?? string.Empty;
        private static readonly string _vector = _config["AppSettings:Vector"] ?? string.Empty;
        private static readonly string _password = _config["AppSettings:EncKey"] ?? string.Empty;
